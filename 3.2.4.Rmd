...
The following questions and "solutions" stem from [Section 3.2](http://r4ds.had.co.nz/data-visualisation.html#first-steps) of Chapter 3 (Data Visualization) in [R for Data Science](http://r4ds.had.co.nz/). The solutions are my best attempts at answers. Issues and pull requests are welcome.
